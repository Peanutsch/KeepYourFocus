...
namespace KeepYourFocus
{
    partial class Focus
    {
        ...
        public void InitializeComponent()
        {
            ...
            textBoxShowResults = new TextBox();
            buttonRetry = new Button();
            checkedListBoxDifficulty = new CheckedListBox();
            ...
            startBTN.TabIndex = 0;
            startBTN.Text = "Click Here To Start";
            ...
            // textBoxShowResults
            // 
            textBoxShowResults.BackColor = SystemColors.ControlDarkDark;
            textBoxShowResults.BorderStyle = BorderStyle.FixedSingle;
            textBoxShowResults.Font = new Font("Microsoft Sans Serif", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            textBoxShowResults.ForeColor = Color.White;
            textBoxShowResults.Location = new Point(241, 277);
            textBoxShowResults.Multiline = true;
            textBoxShowResults.Name = "textBoxShowResults";
            textBoxShowResults.Size = new Size(155, 70);
            textBoxShowResults.TabIndex = 21;
            textBoxShowResults.TextAlign = HorizontalAlignment.Center;
            ...
            checkedListBoxDifficulty.CheckOnClick = true;
            checkedListBoxDifficulty.Font = new Font("Microsoft Sans Serif", 9F, FontStyle.Regular, GraphicsUnit.Point, 0);
            checkedListBoxDifficulty.ForeColor = Color.White;
            checkedListBoxDifficulty.FormattingEnabled = true;
            checkedListBoxDifficulty.Items.AddRange(new object[] { "Default: 6 seq/round", "Easy: 4 seq/round", "Hard: 10 seq/round" });
            checkedListBoxDifficulty.Location = new Point(241, 223);
            checkedListBoxDifficulty.Name = "checkedListBoxDifficulty";
            checkedListBoxDifficulty.Size = new Size(156, 48);
            checkedListBoxDifficulty.TabIndex = 23;
            checkedListBoxDifficulty.ItemCheck += checkedListBoxDifficulty_ItemCheck;
            checkedListBoxDifficulty.SelectedIndexChanged += checkedListBoxDifficulty_SelectedIndexChanged;
            // 
            // Focus
            // 
            ...
            Controls.Add(textBoxShowResults);
